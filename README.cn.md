...
[![x-cmd/install — kpt Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/kpt.svg?lang=zh)](https://x-cmd.com/install/kpt)
...
合计: **79,167** 行代码（覆盖前 5 种语言、共 **980** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 52,287 | 8,075 | 6,226 | 270 |
| Yaml | 17,185 | 5,403 | 301 | 617 |
...
- **上游仓库**: <https://github.com/kptdev/kpt>
- **官网**: <https://kpt.dev>
- **许可证**: Apache-2.0
...
- **Star**: 1,897 · **Fork**: 265 · **开放 issue**: 1,984 · **贡献者**: 130

## 累计统计

- **发布数**: 138 · **已合并 PR**: 2319 · **开放 PR**: 15 · **已关闭 issue**: 1676 · **开放 issue**: 308 · **提交数**: 3147

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 2 | 17 | 10 | 5 | 10 | 28 |
| last60d | 2026-07-25 | 5 | 50 | 10 | 8 | 14 | 56 |
| 90d | 2026-06-25 | 11 | 89 | 11 | 16 | 16 | 94 |
| last180d | 2026-03-27 | 19 | 141 | 12 | 43 | 47 | 201 |
| 360d | 2025-09-28 | 26 | 223 | 13 | 80 | 77 | 345 |
| last720d | 2024-10-03 | 29 | 258 | 13 | 94 | 80 | 477 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/kpt.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T02:56:09Z._
